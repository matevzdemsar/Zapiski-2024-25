...
# =============================================================================
    ...
    def stevilo_listov(self):
        if self.prazno:
            return 0
        if self.levo.prazno and self.desno.prazno:
            return 1
        else:
...
# =============================================================================
    ...
    def minimum(self):
        if self.prazno:
            ...
            kandidati = [self.vsebina, self.levo.minimum(), self.desno.minimum()]
            kandidati = [x for x in kandidati if x != None]
    ...
    def premi_pregled(self):
        if not self.prazno:
            ...
            for i in self.levo.premi_pregled():
                yield i
            for j in self.desno.premi_pregled():
                yield j
    ...
    def po_nivojih(self):
        if not self.prazno:
            ...
            while len(vrsta):
                voz = vrsta.pop(0)
                yield voz.vsebina
                if not voz.levo.prazno:
                    vrsta.append(voz.levo)
                if not voz.desno.prazno:
                    vrsta.append(voz.desno)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTEyLCJ1c2VyIjo5MTQyfQ:1uErNo:9ZrbF0Dv4La1nW-Fu1fFaM4I3tePnSeks1d89Yah0y8"
        try:
            test_data = [
                ('Drevo().vsota()', 0),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTEzLCJ1c2VyIjo5MTQyfQ:1uErNo:-WMK-pVpGnwOfvf4cgK4MphovA1eLoPi3Iiz-DoT7G4"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE0LCJ1c2VyIjo5MTQyfQ:1uErNo:S8PvyLXsCKG5_ZI1ZbY19DgIc6O2OZFyh-Tf7o4l9MM"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE1LCJ1c2VyIjo5MTQyfQ:1uErNo:WiDVXvZKHSDUmDEKejJH5KX_VXpNlllddxoTsSYyN14"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE2LCJ1c2VyIjo5MTQyfQ:1uErNo:k9mIHQG2f2vSR23MqmJDgTkBnODHwMAsUvnURbxKNAY"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1OTE3LCJ1c2VyIjo5MTQyfQ:1uErNo:nyTNKBKX-qAYRBohLs1B50dVGjLreHKF-z8U2R9jBJQ"
        try:
            test_data = [
