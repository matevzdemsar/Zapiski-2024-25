...
#     4
# =============================================================================
prvi_samoglasnik = lambda niz: min([niz.index(char) for char in niz if char in 'aeiouAEIOU'])
# =====================================================================@005659=
# 2. podnaloga
...
#     'Bnn j dbr!aaaeoa'
# =============================================================================
disemvowel = lambda niz: ''.join([char for char in niz if char not in 'aeiouAEIOU']) + ''.join([char for char in niz if char in 'aeiouAEIOU'])
# =====================================================================@005660=
# 3. podnaloga
...
def disemvowel_datoteko(vhodna, izhodna):
    with open(vhodna) as file:
        text = file.readlines()
    with open(izhodna, 'w') as file:
        for line in text:
            file.write(disemvowel(line.strip('\n')) + '\n')
# =====================================================================@005661=
# 4. podnaloga
...
#     'Banana je dobra!'
# =============================================================================
def razveljavi_disemvowel(string):
    output = ''
    not_vowels = [char for char in string if char not in 'aeiouAEIOU']
    vowels = [char for char in string if char in 'aeiouAEIOU']
    expected_char = len(not_vowels)
    for _ in range(expected_char):
        if not_vowels[0] == '*':
            output += vowels[0]
            vowels = vowels[1:]
        else:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NjU4LCJ1c2VyIjo5MTQyfQ:1to1jp:EVXHfZ21IRAKXE4p_d8AzedkHe5p0pSB6NAiwEIzaGo"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NjU5LCJ1c2VyIjo5MTQyfQ:1to1jp:LM3RwElifnSSUFfEvltZ6BTbnCWUVi9NPQqQ4dV6Ns0"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NjYwLCJ1c2VyIjo5MTQyfQ:1to1jp:hMcKpkODdUjU8LNt1XzRAnoQa_9VfO8e0ywAlTw7UZ8"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NjYxLCJ1c2VyIjo5MTQyfQ:1to1jp:8zEZhOxwWz9q1TkoNyxpEMv3386xI4jPIuTophXsr0c"
        try:
            test_data = [
