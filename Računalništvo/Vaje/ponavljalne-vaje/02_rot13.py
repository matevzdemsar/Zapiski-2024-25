...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNTUyMiwidXNlciI6OTE0Mn0:1tnIAD:GQO4pgKQVutldCYzmZniPWRFyV76BjaU0PGk1h3DMHA"
        try:
            test_data = [
                ("en_znakec_rot13('A')", 'Z'),
                ("en_znakec_rot13('a')", 'z'),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNTUyMywidXNlciI6OTE0Mn0:1tnIAD:zUH3c5dIWb1EQtVonXpWc-ry4nbVd2w55Vf3S0BwJog"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNTUyNCwidXNlciI6OTE0Mn0:1tnIAD:QjTwKt_rPW3Z4DdSC05CoO9lqoTX-VR4J33GrhpQzaE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNTUyNSwidXNlciI6OTE0Mn0:1tnIAD:aOg0KnjCWfQuSNcPFBljw-f-TvgkrpvC2_w9j0Gvsbs"
        try:
            test_data = [
