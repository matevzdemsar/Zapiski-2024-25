...
# =============================================================================
fakulteta = lambda x: 1 if x <= 1 else x * fakulteta(x-1)
# =====================================================================@005789=
# 2. podnaloga
...
def cantor(n):
    if n == 0:
        ...
        string = cantor(n - 1)
        return string + 3 ** (n-1) * ' ' + string
    
# Ta rešitev deluje, amapk je počasna
# =====================================================================@005791=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1Nzg4LCJ1c2VyIjo5MTQyfQ:1tpTrI:c8gXwUYkbuzWfpUte4rxIOCSCQqqmgHXRCm-tF36p8w"
        try:
            test_data = [
                ("""fakulteta(3)""", 6),
                ("""fakulteta(5)""", 120),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1Nzg5LCJ1c2VyIjo5MTQyfQ:1tpTrI:9aflLoSTlkMO2A_0ClfbErTTa2v-S5foe_2bgd79SXY"
        try:
            test_data = [
                ("""gcd(31, 6)""", 1),
                ("""gcd(315, 0)""", 315),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NzkwLCJ1c2VyIjo5MTQyfQ:1tpTrI:Cun4o8TadERvxuUXDLFIw6PRLSHGLVbhy_-9GeV8Oyg"
        try:
            test_data = [
                ("cantor(0)", "*"),
                ("cantor(1)", "* *"),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo1NzkxLCJ1c2VyIjo5MTQyfQ:1tpTrI:gQUzeTRC9fut9LxDVP7aa7GIeF_8kw3CY7btC7VL1xg"
        try:
            test_data = [
                ("""fibonacci(1)""", 1),
                ("""fibonacci(3)""", 2),
